...
CSS string containing styling of the highlighted class e.g. `.hljs-string` and `.hljs-number`. [Themes](https://github.com/highlightjs/highlight.js/tree/main/src/styles) examples: `a11y-dark`, `a11y-light`, `github`, `googlecode` and more.
